class ApiConstants {
  // Deployed Django backend on Vercel
  static const String baseUrl =
      'https://mazi-shala-backend.vercel.app/api';
  ...
  static String get repeatedAbsentees =>
      '$baseUrl/attendance/repeated-absentees/';
  static String studentAttendanceHistory(int id) =>
      '$baseUrl/attendance/student/$id/';
  ...
  static String studentHealthDetail(int id) =>
      '$baseUrl/health/student/$id/';
  ...
  static String processLeave(int id) =>
      '$baseUrl/hostel/process-leave/$id/';
  ...
  static String get scholarshipSummary =>
      '$baseUrl/scholarships/summary/';

  // Inventory endpoints
  static String get inventory => '$baseUrl/inventory/';
  static String get inventoryTransactions =>
  ...
  static String get inventorySummary =>
      '$baseUrl/inventory/summary/';

  // Announcements endpoints
  static String get announcements => '$baseUrl/announcements/';
  static String markAnnouncementRead(int id) =>
      '$baseUrl/announcements/mark-read/$id/';

  // Reports endpoints
  static String get principalAnalytics =>
      '$baseUrl/reports/analytics/';
  static String get reportAttendance =>
      '$baseUrl/reports/attendance/';
  static String get reportStudents =>
      '$baseUrl/reports/students/';
  static String get reportHostel =>
      '$baseUrl/reports/hostel/';
  static String get reportInventory =>
      '$baseUrl/reports/inventory/';
  static String get reportScholarships =>
      '$baseUrl/reports/scholarships/';
}